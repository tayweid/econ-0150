...
| 4.2 | Categorical Predictors | Regression with a binary predictor; the two-sample t-test as a special case. |
| 4.3 | Model Assumptions | Checking model assumptions using residuals: linearity, homoskedasticity, independence, normality. |
| 4.4 | The Problem of Timeseries | Regression through time; detecting and addressing autocorrelation with differencing and growth rates. |
...
| Unit | Title | Description |
|------|-------|-------------|
| 5.0 | Causality | Correlation vs causation; confounding variables; why we need control variables. Bridges Part 4 to Part 5. |
