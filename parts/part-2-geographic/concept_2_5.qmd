...
data = pd.read_csv('../../../econ-0150/data/wrapup_01.csv', index_col=0)
...
```{python}
# Industry sectors
data = pd.read_csv('../../../econ-0150/data/wrapup_02.csv', index_col=0)
data.head().style.hide(axis="index")
```
...
```{python}
# Education levels
data = pd.read_csv('../../../econ-0150/data/wrapup_03.csv', index_col=0)
data.head().style.hide(axis="index")
```
...
```{python}
# Income data
data = pd.read_csv('../../../econ-0150/data/wrapup_04.csv', index_col=0)
data.head().style.hide(axis="index")
```
...
```{python}
# Income data
data = pd.read_csv('../../../econ-0150/data/wrapup_05.csv', index_col=0)
data.head().style.hide(axis="index")
```
...
data = pd.read_csv('../../../econ-0150/data/wrapup_06.csv', index_col=0)
data.head().style.hide(axis="index")
```
...
```{python}
# Income vs Age
data = pd.read_csv('../../../econ-0150/data/wrapup_07.csv', index_col=0)
data.head().style.hide(axis="index")
```
...
```{python}
# GDP over time
data = pd.read_csv('../../../econ-0150/data/wrapup_08.csv', index_col=0)
data.head().style.hide(axis="index")
```
...
data = pd.read_csv('../../../econ-0150/data/wrapup_09.csv', index_col=0)
data.head().style.hide(axis="index")
```
...
data = pd.read_csv('../../../econ-0150/data/wrapup_10.csv', index_col=0)
data.head().style.hide(axis="index")
```
