...
import pandas as pd
# Load the data
data = pd.read_csv('../../../econ-0150/data/Starbucks_Location_Hours.csv')
#data.head()
data[['storeNumber', 'country', 'open', 'close', 'duration_hr']].head()
```
...
us_hours = hours[hours['country'] == 'US']
```
...
us_ca = hours[(hours['country'] == 'US') | (hours['country'] == 'CA')]
```
...
# Find the data in either the US or in Canada (CA)
# Method 2: Using isin()
us_ca = hours[hours['country'].isin(['US', 'CA'])]
```
...
hours[(hours['country'] == 'US') & (hours['country'] == 'CN')]
```
...
early_us_ca = hours[(hours['open'] < 7) & (hours['country'].isin(['US', 'CA']))]
```
